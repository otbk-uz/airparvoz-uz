...
export const translations: Translations = {
  ...
  usersCount: { uz: '100 000+ foydalanuvchilar', ru: '100 000+ пользователей', en: '100,000+ users' },
  reviews: { uz: 'Sharhlar', ru: 'Отзывы', en: 'Reviews' },
  ratings: { uz: 'Baholar', ru: 'Оценки', en: 'Ratings' },
  start: { uz: 'Start', ru: 'Старт', en: 'Start' },

  // Banner
  bannerText: { uz: 'Sayohatingizni bir platformada rejalashtiring: aviachipta, mehmonxona, ekskursiya.', ru: 'Планируйте путешествие на одной платформе: авиабилеты, отели, экскурсии.', en: 'Plan your trip on one platform: flights, hotels, excursions.' },
